...
<PAGEID name="awards"/>
     ...
     <TEXT name="text" x="350" y="40" align="center" 
      fontSize="14" textColor="#ffffffff">AWARDS</TEXT>
     
     <GRID name="infoGrid" x="40" y="150" numCols="3" numVisRows="7" numTotalRows="0" 
           colWidth="80"
            rowHeight="20"
            class="GRID1"
            cellAlign="left"
            ...
            borderWidth="1"
            borderHeight="1"
            borderLineColor="#ff000000"
            borderFillColor="#ffffffff"
            borderHighlightLineColor="#ffffffff"
            borderHighlightFillColor="#ff99FFFF"
            borderClass="BORDERGRID1">
            
        <COLUMNS height="20" fontSize="12"
            class="COLUMN1">
            <COLUMN colWidth="150">Award Name</COLUMN> 
            <COLUMN colWidth="150">Icon</COLUMN> 
            <COLUMN colWidth="150">Description</COLUMN>
