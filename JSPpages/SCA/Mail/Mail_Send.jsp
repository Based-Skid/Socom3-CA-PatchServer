...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B" class="TEXT1">CREATE MAIL</TEXT>
     <TEXT name="toolTipText" x="25" y="95" align="left" 
        fontSize="10" textColor="#d0f2e4b3"> </TEXT>
    
    <FORM name="form1" method="POST"
        action="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/mail/Mail_Send_Submit.jsp" >
