...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B" class="TEXT1">CREATE CLAN MAIL</TEXT>
     <TEXT name="toolTipText" x="25" y="95" align="left" 
        fontSize="10" textColor="#d0f2e4b3"> </TEXT>
    
    <FORM name="form1" method="POST"
        action="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/mail/Mail_Clan_Send_Submit.jsp" >
        ...
        <INPUT class="INPUT1" type="text" 
            ...
            textColor="#ff506450" highlightTextColor="#d0f2e4b3"
            selectable="default"
            toolTip="Enter a Subject" toolTipTagName="toolTipText"/>
        ...
        <TEXTAREA class="TEXTAREA2" 
            ...
            textColor="#ff506450" highlightTextColor="#d0f2e4b3"
            toolTip="Enter a Message" toolTipTagName="toolTipText"
            left="submit" down="submit"></TEXTAREA>
        ...
        left="message" up="message"/>
    </FORM>
    
    <BUTTON class="BUTTON1" name="mailBox" x="210" y="333" width="180" height="20"
                textColor="#ff506450" 
                highlightTextColor="#d0f2e4b3" 
                fontSize="10" align="center" 
                href="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/mail/Mail_Box.jsp" 
                down="recipientName"
                toolTip="Return to the Mailbox" toolTipTagName="toolTipText">Mailbox</BUTTON>
