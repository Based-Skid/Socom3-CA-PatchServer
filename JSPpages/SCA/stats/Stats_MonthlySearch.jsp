...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">MONTHLY LEADERBOARD</TEXT>
    
    <TEXT name="toolTipText" x="25" y="95" align="left" 
        fontSize="10" textColor="#d0f2e4b3">Search Leaderboards</TEXT>
         
    <TEXT name="acctTxt" x="250" y="129" class="TEXT3" fontSize="10" textColor="#ff506450" align="right">Player Name:</TEXT>
                 
    <FORM name="search" action="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/stats/Stats_MonthlySearch_Submit.jsp" method="GET">
