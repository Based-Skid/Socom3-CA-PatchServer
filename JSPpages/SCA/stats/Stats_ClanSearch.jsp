...
<TEXT name="pageTitle" x="25" y="70" align="left" 
    ...
    <TEXT name="acctTxt" x="300" y="119" class="TEXT3" fontSize="10" textColor="#ff506450" align="right">Clan Name:</TEXT>
            
    <FORM name="search" action="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/stats/Stats_ClanSearch_Submit.jsp" method="GET">
    
    <INPUT type="text" x="310" y="115" width="205" height="25" 
            name="clan" 
            maxLength="32" 
            value="" toolTip="Enter Clan Name" toolTipTagName="toolTipText" fontSize="10"
            class="INPUT1" selectable="default" textColor="#ff506450" highlightTextColor="#d0f2e4b3" />
