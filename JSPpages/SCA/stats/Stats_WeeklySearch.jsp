...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">WEEKLY LEADERBOARD</TEXT>
    ...
    <FORM name="search" action="http://socomca.socom3-prod.svo.ps2.online.scea.com:10060/SOCOMCA_SVML/stats/Stats_WeeklySearch_Submit.jsp" method="GET">
