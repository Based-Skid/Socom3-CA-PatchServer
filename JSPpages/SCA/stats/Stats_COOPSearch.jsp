...
<TEXT name="pageTitle" x="16" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">SEARCH CO-OP LEADERBOARD</TEXT>
    ...
    <FORM name="search" action="Stats_COOPSearch_Submit.jsp" method="GET">
   ...
   <INPUT type="text" x="260" y="125" width="250" height="25"
    ...
    <INPUT type="hidden" name="gameMode" value="8" />         
