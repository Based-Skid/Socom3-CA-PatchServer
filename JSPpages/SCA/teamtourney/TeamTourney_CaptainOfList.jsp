...
<SVML>
    <PAGEID name="pageID_TeamTourney_CaptainOfList" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">TOURNAMENTS WHERE I'M A TEAM CAPTAIN</TEXT>

    <TEXT name="text" x="320" y="154" align="center" fontSize="10" 
        textColor="#ff426478">You Are Not the Captain of any Tournaments</TEXT>
    <GRID name="grid1" x="25" y="110"  numCols="3" numVisRows="10" numTotalRows="0"
    	    colWidth="60"
            rowHeight="19"
            class="GRID1"
            cellFontSize="10"
	 ...
	 <COLUMNS height="20" fontSize="10"
	    ...
	    fillColor="#00000000" highlightFillColor="#00000000"
            class="COLUMN1">
            <COLUMN colWidth="215">TOURNEY NAME</COLUMN>
            <COLUMN colWidth="215">TEAM NAME</COLUMN>
