...
<SVML>
<PAGEID name="pageID_TeamTourney_List" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">ACTIVE TOURNAMENT LIST</TEXT>

    <TEXT name="text" x="110" y="164" align="center" fontSize="10" 
        textColor="#ff426478">
            No Team Tournaments Currently Availiable</TEXT>
    <GRID name="grid1" x="25" y="120"  numCols="5" numVisRows="9" numTotalRows="0"
    	    colWidth="60"
            rowHeight="19"
            class="GRID1"
            cellFontSize="9"
	    ...
	    textColor="#ff708C70"
            ...
            class="COLUMN1">
            <COLUMN colWidth="150">NAME</COLUMN>
            <COLUMN colWidth="125">SIGNUP START</COLUMN>
            <COLUMN colWidth="115">TOUR START</COLUMN>
            <COLUMN colWidth="75">STATUS</COLUMN>
            <COLUMN colWidth="125">HOST</COLUMN>
        </COLUMNS>
    ...
    <TEXT name="text" x="340" y="350" align="center" class="TEXT3">
        </TEXT>
