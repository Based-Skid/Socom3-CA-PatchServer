...
<SVML>
    <PAGEID name="pageID_TeamTourney_RequestedToJoinList" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">REQUESTING TO JOIN</TEXT>

    <TEXT name="text" x="320" y="154" align="center" fontSize="10" 
        textColor="#ff426478">You Have Not Requested to Join any Tournaments</TEXT>
    ...
    <GRID name="grid1" x="25" y="110"  numCols="4" numVisRows="10" numTotalRows="0"
	 ...
	 <COLUMNS height="20" fontSize="9"
	    ...
	    fillColor="#00000000" highlightFillColor="#00000000"
            class="COLUMN1">
            <COLUMN colWidth="150">TOURNEY NAME</COLUMN>
            <COLUMN colWidth="150">TEAM NAME</COLUMN>
            <COLUMN colWidth="175">SIGNUP END</COLUMN>
