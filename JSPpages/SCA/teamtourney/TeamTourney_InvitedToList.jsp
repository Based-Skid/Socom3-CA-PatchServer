...
<SVML>
     <PAGEID name="pageID_TeamTourney_InvitedToList" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">I'M INVITED TO</TEXT>

    <TEXT name="text" x="320" y="154" align="center" fontSize="10" 
        textColor="#ff426478">No Requests Have Been Made</TEXT>
    <GRID name="grid1" x="25" y="110"  numCols="6" numVisRows="10" numTotalRows="0"
    	    colWidth="60"
            rowHeight="19"
            class="GRID1"
            cellFontSize="9"
	 ...
	 <COLUMNS height="20" fontSize="9"
	    ...
	    fillColor="#00000000" highlightFillColor="#00000000"
            class="COLUMN1"> 
            <COLUMN colWidth="125">TOURNEY NAME</COLUMN>
            <COLUMN colWidth="125">TEAM NAME</COLUMN>
            <COLUMN colWidth="125">SIGNUP END</COLUMN>
            <COLUMN colWidth="125">STATUS</COLUMN>
            <COLUMN colWidth="50">ACCEPT</COLUMN>
            <COLUMN colWidth="50">REJECT</COLUMN>
        </COLUMNS>
