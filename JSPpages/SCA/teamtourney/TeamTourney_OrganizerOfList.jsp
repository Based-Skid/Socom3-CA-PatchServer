...
<SVML>
    <PAGEID name="pageID_TeamTourney_OrganizerOfList" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">ORGANIZER OF</TEXT>

    <TEXT name="text" x="320" y="154" align="center" fontSize="10" 
        textColor="#ff426478">You Are Not the Organizer of any Tournaments</TEXT>
    <GRID name="grid1" x="25" y="110"  numCols="5" numVisRows="10" numTotalRows="0"
    	    colWidth="60"
            rowHeight="19"
            class="GRID1"
            cellFontSize="9"
	 ...
	 <COLUMNS height="20" fontSize="9"
	    ...
	    fillColor="#00000000" highlightFillColor="#00000000"
            ...
            <COLUMN colWidth="75">SIGNUP START</COLUMN>
            <COLUMN colWidth="75">TOUR START</COLUMN>
            <COLUMN colWidth="100">STATUS</COLUMN>
            <COLUMN colWidth="150">HOST</COLUMN>
        </COLUMNS>
