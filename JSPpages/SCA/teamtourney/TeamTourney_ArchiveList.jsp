...
<SVML>
    ...
    <PAGEID name="pageID_TeamTourney_ArchiveList" />
...
<TEXT name="pageTitle" x="25" y="70" align="left" 
        fontSize="12" textColor="#ff95994B">ARCHIVED TOURNAMENTS</TEXT>

    <TEXT name="text" x="320" y="154" align="center" fontSize="10" 
        textColor="#ff426478">No Team Tournaments Currently Availiable</TEXT>
    <GRID name="grid1" x="25" y="110"  numCols="4" numVisRows="10" numTotalRows="0"
    	    colWidth="60"
            rowHeight="19"
            class="GRID1"
            cellFontSize="9"
	 ...
	 <COLUMNS height="20" fontSize="9"
	    ...
	    fillColor="#00000000" highlightFillColor="#00000000"
            class="COLUMN1">
            <COLUMN colWidth="185">NAME</COLUMN>
            <COLUMN colWidth="155">START</COLUMN>
            <COLUMN colWidth="150">END</COLUMN>
            <COLUMN colWidth="100">WINNER</COLUMN>
        </COLUMNS>
    ...
    <TEXT name="text" x="250" y="335" fontSize="10"textColor="#ff506450" align="center" class="TEXT3">
